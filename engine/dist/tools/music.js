...
export async function playMusic(params) {
    const { action, prompt, duration_seconds = 30, volume = 0.25, loop = true, force_instrumental = true, output_path, } = params;
    if (action === "stop") {
        stopCurrentMusic();
...
function getMusicPlayer(filePath, volume, loop) {
