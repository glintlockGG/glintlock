...
// --- update_entity ---
server.tool("update_entity", "Modify a component on an existing entity. Supports set (replace value), delta (add/subtract number), push (add to array), and remove (delete from array) operations.", {
...
// --- create_entity ---
server.tool("create_entity", "Create a new entity with initial components. The entity ID is auto-generated from type and name (e.g. 'npc_merchant_vela'). Provide any initial component data.", {
