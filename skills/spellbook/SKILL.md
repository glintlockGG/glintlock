...
**Augury** — Self. Instant. Ask GM one question about a specific course of action. GM answers "weal" or "woe."

**Bless** — Close. Instant. One touched creature gains a luck token.
...
**Zone of Truth** — Near. Focus. One visible creature can't utter deliberate lies while in range.
...
**Detect Thoughts** — Near. Focus. Read one visible creature's immediate thoughts each round. Target WIS check vs your spellcasting check on its turn. Success = notices you, spell ends.

**Fixed Object** — Close. 5 rounds. Object ≤5 lbs becomes fixed in place. Supports up to 5,000 lbs.

**Hold Person** — Near. Focus. Paralyze one visible humanoid LV 4 or less.

**Invisibility** — Close. 10 rounds. Touched creature becomes invisible. Ends if target attacks or casts a spell.

**Knock** — Near. Instant. One visible door/window/gate/chest/portal opens, defeating all mundane locks. Creates loud knock audible to all in earshot.

**Levitate** — Self. Focus. Float near distance vertically per round. Push against solid objects to move horizontally.
...
**Web** — Far. 5 rounds. Near-sized cube of sticky web. Stuck creatures can't move. STR check vs spellcasting check to free.
